/** Uniswap V3 TickMath.getSqrtRatioAtTick — exact Q64.96 */

const MAX_TICK = 887272

export function getSqrtRatioAtTick(tick: number): bigint {
  if (tick < -MAX_TICK || tick > MAX_TICK) throw new Error(`tick out of range: ${tick}`)
  ...
  if ((absTick & 0x800n) !== 0n) ratio = (ratio * 0xe7159475a2c29b7443b29c7fa6e89d64n) >> 128n
